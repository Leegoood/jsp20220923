...
<body>
	...
	<!-- select>option[value="val$"]*3>lorem1 -->
		<select name="sel1" id="">
			...
			<option value="val2" selected>Praesentium.</option>
			<option value="val3">Ratione.</option>
		</select>
		<br />
		여러개 선택 가능
		...
		<select name="sel2" multiple>
			<option value="val1">Lorem.</option>
			<option value="val2">Exercitationem!</option>
			<option value="val3">Voluptatem.</option>
		</select>
		<br />
